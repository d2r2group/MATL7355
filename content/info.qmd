...
**Canvas Website**: [northeastern.instructure.com/courses/124384](https://northeastern.instructure.com/courses/124384)\
...
- know the difference between exact and inexact differentials and the difference between path and state functions.
- will be able to do thermochemistry calculations and understand temperature dependence of heat capacity and enthalpy.
- know the basics of statistical thermodynamics and what micro/macrostates are.
- be able to use Maxwell's relations.
- understand and be able to read single component and binary (and ternary) phase diagrams.
- understand ideal and non-ideal gas behavior.
- know the basics of solution thermodynamics (Henry and Raoult's laws and Hume-Rothery rules).
