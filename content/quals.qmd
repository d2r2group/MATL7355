...
- Ideal and non-ideal solutions (regular solution model)
- Tangent construction and chemical potential
...
::: {.callout-important title="Number of Questions and Duration"}
MSE Part I will contain *three questions*. Students are asked to choose and solve exactly *two* of them.
...
::: {.callout-note}
A printed formula sheet will **not** be provided in this exam. However, all questions of MSE Part I will state the key equations and constants
needed to solve the problem.
:::

### Additional Details for the 2026 Exam

The points below only apply to the exam held in 2026 and may slightly change in future years.
